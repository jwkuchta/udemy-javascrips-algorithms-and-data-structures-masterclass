// Big O of a hash depends of how good the hashing function is and 
// it is better to use the built in function than to write your own
// a good hashing algorithms is O(n)

// closer to Maps in JavaScript, dictionaries in Python
