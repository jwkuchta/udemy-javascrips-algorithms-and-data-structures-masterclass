...
// handling collitions:
// 1. SEPARATE CHAINING
// store the colliding pieces of data together in another nested structure
// 2. LINEAR PROBING
// only store one piece of data, and in case of a collision, we look forward to the next empty slot